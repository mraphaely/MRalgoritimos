...
//                <span class="${character.title}">${character.family} </span>
//            </article>
//           `;
...
function showCharacter(characters){
    ...
    characters.map((character)=>{
          ...
          <img id="img-character" src="${character.imageUrl}" alt="imagem do personagem"> 
            ...
            <article class="character-info">
              <h3>${character.fullName}</h3><br>
               
              <span>First Name:</span>
               <a class="informaciones" href="${character.firstName}">${character.firstName}</a>

              <span >Last Name:</span>
               <a class="informaciones" href="${character.lastName}">${character.lastName}</a>

              <span >Title:</span>
               <a class="informaciones" href="${character.title}">${character.title}</a>
  
               <span>Family:</span>
               <a  class="informaciones" href="${character.family}">${character.family}</a>
           </article>
          `;
          divCharacter.classList.add("character-box");
          characterContainer.appendChild(divCharacter);
